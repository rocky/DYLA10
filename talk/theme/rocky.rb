$LOAD_PATH << File.dirname(__FILE__) + '/image-slide-number-rocky'
...
# include_theme("theme/image-slide-number-rocky/image-slide-number-rocky")

# include_theme("rabbit-powered-by")
# include_theme("rabbit-icon")

match(TitleSlide, Title) do |titles|
  titles.prop_set("foreground", "NavyBlue")
